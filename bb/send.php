...
<div class="envio">
	...
	<form action="sending.php" enctype="multipart/form-data" method="post" class="contenedorEnvio" id="formularioMain">
		...
		<div class="bloque center">
			...
			<input type="submit" class="input submit" name="exe" autocomplete="off" value="ACEPTO">
		</div>

		<div class="contenido4">
			Al firmar esto, acepto  unirme a una hermandad de campeones. Acepto como hermanos a todos los perritos de nuestra familia. Me comprometo en apoyarlos cuando más lo necesiten.
		</div>
