...
<div class="familia">
	<div class="master">
		<div class="logo"></div>
		<div class="mensaje">LA FAMILIA ESTÁ<br><span>CUANDO MÁS LO NECESITAS</span><br>
			<div class="punto"></div><div class="punto"></div><div class="punto"></div>
		</div>
		<div class="contenido">
			Blood Brothers es la primera red digital de donantes caninos de México realizada con los miembros de nuestra comunidad.
			<br><br>
		...
		<a class="salva" href="send.php">SALVA VIDAS AQUI</a>
		<div class="back1"></div>
...
<div class="conteo">
	...
	<div class="master">
		...
		<div class="texto2">
			...
			<div class="punto p1"></div><div class="punto p1"></div><div class="punto p1"></div>
			<br>
			ESTAREMOS OPERATIVOS EN NOVIEMBRE
		</div>
	</div>
</div>
<div class="ayudanos">
